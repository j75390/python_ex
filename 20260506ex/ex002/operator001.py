...
# quiz)dw 전자 하사에서 1분기 매출의 총합을 구하고자 합니다. 프로그램을 작성해봅시다.
# sales1 = int(input('1월 매출: '))
# sales2 = int(input('2월 매출: '))
# sales3 = int(input('3월 매출: '))
# total = sales1 + sales2 + sales3
# \033[31m → 빨강, \033[32m → 초록, \033[0m → 초기화
# print(f'분기 매출: {total:,}원')

# print(f'\033[32m1분기 매출: {total:,}원\033[0m') 색깔넣은거
# \033[31m → 빨강 \033[32m → 초록 \033[33m → 노랑 \033[34m → 파랑
