...
# 튜플 조회
'''
튜플은 아이템의 수정이 불가능하기 떄문에 아이템의 삽입, 삭제, 정렬 등의 기능은 없고
조회하는 기능을 주로 사용합니다.
'''
...
# 튜플 내 특정 아이템의 인덱스를 확인할 때 index() 함수를 이용합니다.
# fruits = ('사과', '포도', '수박', '참외', '배', '자두', '복숭아', '바나나')
...
# 튜플 안의 아이템 유/무 확인하기
# in과 not in 키워드를 사용하면 튜플 안에 특정 아이템의 존재 유/무를 확일할 수 있습니다.
