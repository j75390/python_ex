...
print(f'fruits[1]: {fruits[2]}')    # 복숭아
print(f'fruits[1]: {fruits[0]}')    # 사과
# print(f'fruits[1]: {fruits[3]}')    # IndexError: list index out of range
...
for idx, fruits in enumerate(fruits):                 # 인덱스, 아이템
...
# pop() vs del
nums = [1, 2, 3, 4, 5, 6]
deletedNum = nums.pop(3)   # [1, 2, 3, 4, 5, 6]
print(f'deletedNum: {deletedNum}')

# 특정 아이템 삭제 by 아이템
languages = ['c/++', 'c#', 'java', 'python']
# languaages.pop(2)           #['c/++', 'c#', 'python']
...
languages = ['c/++', 'c#', 'java', 'python', 'java']
languages.remove('java')
print(f'languages: {languages}') # ['c/++', 'c#', 'python', 'java']
...
# print(f'평균: {total / TARGET_CNT}')   # 지양하자! (최대한 비사용)
print(f'평균: {average:.2f}')    # 지향하자! (최대한 이렇게 사용할것)
