# 자주 사용하는 모듈: 내장 모듈
# 이러한 내장 모듈들은 절대로 외위는 것이 아니죠
# 따라서 가볍게 흝어보고 필요할 떄 찾아서 사용하면 됩니다.
...
print(f'math.fabs(-3.1455): {math.fabs(-3.1415)}')  # 절댓값
print(f'math.ceil(-3.1455): {math.ceil(-3.1415)}')  # 올림
print(f'math.floor(-3.1455): {math.floor(-3.1415)}')  # 내림
print(f'math.trunc(-3.1455): {math.trunc(-3.1415)}')  # 버림
...
print(f'월: {It.tm_mon}')    # 월  5

week = ['월요일', '화요일', '수요일', '목요일', '금요일', '토요일', '일요일']

print(f'요일: {week[It.tm_wday]}')    # 요일 1  --> (화요일)
'''
0: 월요일
1: 화요일
2: 수요일
